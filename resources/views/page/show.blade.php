    ...
    <div id="carouselExampleControls h-50" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner h-50">
          ...
          <div class="carousel-item h-50">
            <img id="myImg" src="{{ asset('storage/'.$path)}}" alt="nezari" class="d-block" style="width:100%">
        </div>
        @endforeach
        <div  id="myModal" class="modal"  >
            ...
            <div class="modal-header">
                <button type="button" class="btn-close button-danger" style=" font-size: 44px;   color: #fb0202;
                background: white;" data-bs-dismiss="modal" aria-label="Close"><i style=" font-size: 53px;" class="fas fa-times"></i></button>
              </div>
                ...
                <div class="col-lg-5 ">
                    <div class="products-info">
                        ...
                        <ul>
                            ...
                            <li><strong>{{__("Country")}} </strong> : {{ $data->company->{app()->getLocale().('_country')} }}</li>
