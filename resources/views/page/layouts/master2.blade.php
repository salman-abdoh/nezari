        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown" style=" justify-content: space-around;">
            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0" >
                <li class="nav-item active">
                    <a class="nav-link px-4 {{request()->is('index') ? 'active' : ''}}" href="{{ asset ('index')}}">{{ __("Home") }}  </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link px-4  {{request()->is('Products') ? 'active' : ''}}" href="{{ asset ('index#products')}}">{{ __("Our Products") }} </a>
                </li>
                <li class="nav-item">
            <a class="nav-link px-4  {{request()->is('index#services') ? 'active' : ''}}" href="{{ asset ('index#services')}}">
              {{ __("Our Services") }}</a>
                ...
                <li class="nav-item">
                    <a class="nav-link px-4  {{request()->is('contact') ? 'active' : ''}}" href="{{ asset ('contact')}}">{{ __("Contact Us") }} </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-4  {{request()->is('about') ? 'active' : ''}}" href="{{ asset ('about')}}">{{ __("About Us") }} </a>
                </li>
